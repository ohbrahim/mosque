...
try {
    ...
    // تحديث البلوكات التي تحتوي على iframe أو marquee
    $db->query("UPDATE blocks SET is_safe = 1, allow_html = 1 WHERE block_type IN ('iframe', 'marquee', 'custom', 'html')");
    echo "✅ تم تحديث البلوكات لتكون آمنة<br>";
    ...
    $defaultBlocks = [
        ...
        [
            'title' => 'إعلانات هامة',
            'content' => '<div class="alert alert-info"><marquee direction="right" scrollamount="3" behavior="scroll"><span style="color: #d63384; font-weight: bold; font-size: 16px;">🔔 إنطلاق بث قنوات دروس الدعم لجميع المستويات والأطوار على موقع الديوان الوطني للتعليم والتكوين عن بعد: http://www.onefd.edu.dz/soutien-scolaire</span></marquee></div>',
            'block_type' => 'marquee',
            'position' => 'top',
            'status' => 'active',
            'show_title' => 0,
