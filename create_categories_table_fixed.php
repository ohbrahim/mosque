...
try {
    ...
    // إنشاء جدول التصنيفات بدون قيود مرجعية ذاتية
    $createTableSQL = "
    ...
    echo "<p><a href='archive_integrated.php' style='background: #007bff; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;'>🔗 اذهب إلى صفحة الأرشيف المحسنة</a></p>";
    ...
    // معلومات إضافية للتشخيص (بدون getAttribute)
    echo "<h4>معلومات التشخيص:</h4>";
    echo "<ul>";
    echo "<li><strong>وقت الخطأ:</strong> " . date('Y-m-d H:i:s') . "</li>";
    echo "<li><strong>الملف:</strong> " . __FILE__ . "</li>";
    echo "</ul>";
}
?>
