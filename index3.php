...
// تضمين ملف التحديث التلقائي
require_once 'includes/auto_refresh_blocks.php';

// تحديث البلوكات تلقائياً
autoRefreshBlocks($db);
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="?page=about2" class="text-light">عن المسجد</a></li>
...
<?php echo addVisitorStatsScript(); ?>
</html>
